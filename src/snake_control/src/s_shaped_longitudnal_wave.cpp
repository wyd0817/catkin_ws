 ...
 * @detail
*/
void SShapedLongitudnalWave::set_t(double t)
{
 ...
 * @detail
*/
void SShapedLongitudnalWave::WindingShift(RobotSpec spec)
{
	while(s_ > (pre_s_ + step_s_)){  //
		...
		SShapedLongitudnalWave::CalculateTargetAngleToWinding(spec);
 ...
 * @detail
*/
void SShapedLongitudnalWave::CalculateTargetAngleToWinding(RobotSpec spec)
{
